...
class catalogo : AppCompatActivity() {
    ...
    fun cargarSeries() {
        ...
        series.add(Pelicula("El Monstruo de la Vieja Séul", R.drawable.elmonstruo, R.drawable.elmonstruovieja, "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana.", arrayListOf<Cliente>()))
